...
import { ReactComponent as YoutubeIcon } from '../../../../../../assets/icons/brands/social/youtube.svg';
import { ReactComponent as GithubIcon } from '../../../../../../assets/icons/brands/social/github.svg';
...
const ProjectSectionContainer = ({ project, cardVariant, onDelete, index }) => {
    ...
    return (
        <ProfileCardSection cardVariant={cardVariant}>
            ...
            <ProfileCardSectionSubtitle>{project.tech}</ProfileCardSectionSubtitle>
            <ProfileCardSectionSubtitle>{project.tech2}</ProfileCardSectionSubtitle>
                ...
                <div className={classes.detail}>
                    <AnimatedUnderlinedButton color={color}>
                        <a className={classes.link} href={link} target="_blank">
                            <Typography variant="body1" classes={{ container: classes.salary }} color={color}>
                                <LinkIcon className={classes.detailIcon} />
                                <FormattedMessage id="Project.section.link" defaultMessage="Project" />
                            </Typography>
                        </a>
                    ...
                    <AnimatedUnderlinedButton color={color}>
                        <a className={classes.link} href={link} target="_blank">
                            <Typography classes={{ container: classes.salary }} color={color}>
                                <GithubIcon className={classes.detailIcon} />
                                <FormattedMessage id="Project.section.link" defaultMessage="Github" />
                            </Typography>
                        </a>
                    </AnimatedUnderlinedButton>
                </div>
            ...
            {project.youtube && (
                <div className={classes.detail}>
                    <AnimatedUnderlinedButton color={color}>
                        <a className={classes.link} href={link} target="_blank">
                            <Typography classes={{ container: classes.salary }} color={color}>
                                <YoutubeIcon className={classes.detailIcon} />
                                <FormattedMessage id="Project.section.link" defaultMessage="Demo" />
                            </Typography>
                        </a>
                    </AnimatedUnderlinedButton>
                </div>
